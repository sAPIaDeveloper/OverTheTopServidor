...
public class InformacionCompartida {
    ...
    public synchronized void addEventoMandoAJugadores(int codPartida,String codEmparejamiento,String accion){
   ...
   public void removeListaMensajes(String rol,String cod_emparejamiento){
       if(rol.equals("movil")){
